...
mod tests {
    ...
    #[cfg(feature = "descriptor-fingerprint")]
    const EXPECTED_V1: boomerang_runtime::binding::DescriptorFingerprint =
        boomerang_runtime::binding::DescriptorFingerprint::new([
            0x7c, 0x4d, 0x0f, 0xbe, 0x54, 0x2a, 0xbb, 0x62, 0xb3, 0x4d, 0x94, 0x35, 0xdd, 0x3c,
            0x0f, 0x40, 0x68, 0x88, 0xeb, 0x2d, 0x74, 0x0c, 0x18, 0x37, 0x7f, 0x8d, 0x1a, 0x57,
            0x0c, 0x13, 0x5f, 0x76,
        ]);
    ...
    fn complete_descriptor_with_contract_version_and_macro_abi(
        ...
        let codec = CodecSlotId::new("codec").unwrap();
        let group = PlacementGroupSlotId::new("group").unwrap();
        let enclave = EnclaveSlotId::new("enclave").unwrap();
        let mut parts = Parts {
            reactors: vec![
                ReactorSlot {
                    id: child.clone(),
            ...
            relationships: vec![
                ...
                DescriptorRelationship {
                    reaction: ReactionSlotId::new("Root/reaction").unwrap(),
            ...
            enclaves: vec![DescriptorEnclave { id: enclave, root }],
        };
