...
pub struct ConnectionSenderReaction<'a, T: runtime::PortData + runtime::ActionData + Clone> {
    input: runtime::InputRef<'a, T>,
    act: runtime::ActionRef<'a, T>,
}

impl<T: runtime::PortData + runtime::ActionData + Clone> runtime::FromRefs
    for ConnectionSenderReaction<'_, T>
{
...
impl<T: runtime::PortData + runtime::ActionData + Clone> runtime::Trigger<()>
    for ConnectionSenderReaction<'_, T>
{
...
pub struct ConnectionReceiverReaction<'a, T: runtime::PortData + runtime::ActionData> {
    act: runtime::ActionRef<'a, T>,
    output: runtime::OutputRef<'a, T>,
}

impl<T: runtime::PortData + runtime::ActionData> runtime::FromRefs
    for ConnectionReceiverReaction<'_, T>
{
