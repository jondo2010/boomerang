...
The most important data structure for Builder is the [`Assembly`], which also serves as the API entry-point. Once all
of the Reactors and Reactions have added their graph state into the [`Assembly`], [`Assembly::into_runtime_assembly`]
