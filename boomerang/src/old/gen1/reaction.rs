...
pub type OutputTrigger<S> = (Rc<RefCell<dyn IsPresent>>, Vec<Rc<Trigger<S>>>);
    ...
    S: Sched,
{
    ...
    pub triggers: Vec<OutputTrigger<S>>,
    ...
    S: Sched,
{
    fn eq(&self, other: &Self) -> bool {
        (self.reactor.as_ref() as *const _) == (other.reactor.as_ref() as *const _)
